...
\newcommand{\fiber}{\tcode{std::fiber\_context}\xspace}
\newcommand{\unwindex}{\tcode{std::unwind\_exception}\xspace}
\newcommand{\unwindfib}{\tcode{std::unwind\_fiber()}\xspace}
\newcommand{\op}{\tcode{operator()()}\xspace}
\newcommand{\opbool}{\tcode{operator bool()}\xspace}
\newcommand{\resume}{\tcode{resume()}\xspace}
\newcommand{\resumewith}{\tcode{resume\_with()}\xspace}
\newcommand{\xtresume}{\tcode{resume\_from\_any\_thread()}\xspace}
\newcommand{\xtresumewith}{\tcode{resume\_from\_any\_thread\_with()}\xspace}
\newcommand{\canresume}{\tcode{can\_resume()}\xspace}
\newcommand{\canxtresume}{\tcode{can\_resume\_from\_any\_thread()}\xspace}
\newcommand{\thread}{\tcode{std::thread}\xspace}
\newcommand{\Currthread}{The calling thread\xspace}
\newcommand{\currthread}{the calling thread\xspace}
\newcommand{\lastthread}{the thread on which the fiber represented by \tcode{*this} was most recently run\xspace}
